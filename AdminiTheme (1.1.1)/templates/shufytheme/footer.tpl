   {if $loginpage eq 0 and $templatefile ne "clientregister" and $templatefile ne "verify-email" and $templatefile ne "password-reset-container"}
	...
	{if file_exists("$shuffythemedirectionfooter")}
		{include file="$shuffythemedirectionfooter"}
	{else}
		{include file="$template/viewsendedemail.tpl"}
	{/if}
	</div>
	{/if}
	</div>
	...
	{if $coodivsettings.cookiesbox=='activated' || $coodivsettings.id != '1'}
		{include file="$template/includes/theme-core/cookies-box.tpl"}
	{/if}
	...
	<script src="{$WEB_ROOT}/templates/{$template}/assets/js/lib/slick.min.js"></script>
	<script src="{$WEB_ROOT}/templates/{$template}/assets/js/lib/select2.min.js"></script>
    <script src="{$WEB_ROOT}/templates/{$template}/assets/js/app.js?v=1.1.1"></script>
