<div class="{$coodivsettings.loginstyle} main__login__content__wrapper">
	<div class="main__login__content">
	
	<div class="autho__logo__wrapper website__identity__sidebar {if $coodivsettings.loginstyle!='loginstyletwo'}d-lg-none{/if} d-flex align-items-center justify-content-center mb-8">		
	...
	<form method="post" action="{routePath('login-validate')}" class="login-form" role="form">
		<div class="{if $coodivsettings.loginstyle=='loginstyleone' || $coodivsettings.id != '1'}panel__without__shadow{/if} default__shadow__panel">
