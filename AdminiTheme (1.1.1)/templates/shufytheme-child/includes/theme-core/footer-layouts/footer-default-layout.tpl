				...
				<div class="col-lg-4 col-12 mb-lg-0 mb-15 {if $coodivfootersettings.themefootersettingstyle=='footerlayoutstylethree' || $coodivfootersettings.themefootersettingstyle=='footerlayoutstylesix'}order-12{/if}">
					...
					{if $coodivfootersettings.themefootersettinglogo=='activated' || $coodivfootersettings.id != '1'}
						<div class="footer__logo__wrapper website__identity__sidebar d-flex align-items-center justify-content-center mb-4">		
							<a class="website__identity__sidebar__link text-center d-flex align-items-center gap-10" href="{$WEB_ROOT}/index.php">
					...
					{if $coodivfootersettings.themefootersettingdescription == null}
						Access the full potential of WHMCS with Shufy themes, featuring a new user-friendly client area, simplified ordering process, and much more!
					{else}
