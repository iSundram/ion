	  ...
	  <div class="page__container">
		  <div class="header__row d-flex justify-content-between align-items-center">
				<div class="top__header__website__identity website__identity__sidebar {if $coodivlayoutssettings.layoutsettingssidebarstyle=='sidebarheaderlogo'}d-flex{else}d-md-none d-flex{/if} align-items-center">		
					...
					<a class="website__identity__sidebar__link" href="{$WEB_ROOT}/index.php">
					...
					{if !$loggedin}
						<div class="header__not__loggined__btns">
							{if $condlinks.allowClientRegistration=='on'}
								<a class="header__link header__not__loggined__btns__item" href="{$WEB_ROOT}/register.php"><i class="far fa-users"></i> <span class="text d-md-flex d-none">{lang key='clientregistertitle'}</span></a>
							{/if}
							<a class="button header__button ml-lg-2 header__not__loggined__btns__item " href="{$WEB_ROOT}/login.php"><i class="far fa-user"></i> <span class="text d-md-flex d-none">{lang key='account'}</span></a>
						</div>
					{/if}
				</div>
		  </div>
