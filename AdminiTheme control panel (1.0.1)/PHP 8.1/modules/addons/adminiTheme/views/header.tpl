		...
		<div class="container-fluid">
			<nav class="navbar__coodiv">
				<div class="coodiv__admin__navbar__logo">
					<a class="logo" href="{$modurl}"><img src="../modules/addons/adminiTheme/assets/img/coodiv-logo.png" alt="Coodiv logo"></a>
					<span class="addon__version">1.0.0</span>
				</div>
				...
				<li><a data-toggle="tooltip" data-placement="bottom" title="Documentation" href="https://demo.coodiv.net/adminitheme/documentation/index.html" target="_blank"><i class="fad fa-file-alt"></i></a></li>
